...
namespace IDSTORE2.Models
{
    public class FileOverride : File
    {
        ...
        //}
        public FileOverride(byte[] content, string _name, string _type = null, string _description = null, string _path = null)
        {          
            if (content != null)
            {
                Content = content;
        ...
        public FileOverride(string _name, string _type = null, string _description = null, string _path = null)
        {
            if (_name != null)
            {
                Name = _name;
